...
git clone https://github.com/ShownShaiju/bash-scripting.git
cd bash-scripting
...
Suggestions, improvements, and new script ideas are welcome — feel free to open an issue or submit a pull request.
